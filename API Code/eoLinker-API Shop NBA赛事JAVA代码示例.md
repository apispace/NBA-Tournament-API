...
本代码示例是基于JAVA的eoLinker-API Shop **按对战球队查询篮球赛事** API服务请求的代码示例，使用前你需要：
   ...
   public static InputStream httpRequestToStream(String url, String requestMethod, Map<String, String> params)
   {
       InputStream is = null;
        ...
        public static void main(String args[])
        {
            ...
            params.put("team1", "参数2");
            params.put("team2", "参数3");
            params.put("page", "参数4");
            params.put("pageSize", "参数5");
            String result = null;
            try
            {
...
本代码示例是基于Java的eoLinker-API Shop **按年份查询篮球赛事** API服务请求的代码示例，使用前你需要：
...
本代码示例是基于Java的eoLinker-API Shop **按球队查询篮球赛事** API服务请求的代码示例，使用前你需要：
